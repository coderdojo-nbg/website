plugin.Tx_Formhandler.settings.predef.mentor {
	name							= Registrierung als Mentor
	formID							= formhandler-mentor
			...
			config{
				admin {
					...
					type {
						...
						ninja						= TEXT
						ninja.data					= LLL:fileadmin/facsimile/.templates/lang/formhandler.xml:mentor.type.ninja
						mentor						= TEXT
						mentor.data					= LLL:fileadmin/facsimile/.templates/lang/formhandler.xml:mentor.type.mentor
						helper						= TEXT
						helper.data					= LLL:fileadmin/facsimile/.templates/lang/formhandler.xml:mentor.type.helper
					}
					sender_email					= email
