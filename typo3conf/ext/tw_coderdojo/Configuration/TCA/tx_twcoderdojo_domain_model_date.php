	...
	'columns' => array(
		...
		'ninjas' => array(
			...
			'config' => array(
				...
				'renderType' => 'selectMultipleSideBySide',
				'foreign_table' => 'tx_twcoderdojo_domain_model_person',
				'foreign_table_where' => 'AND tx_twcoderdojo_domain_model_person.type = 1 AND tx_twcoderdojo_domain_model_person.hidden = 0 AND tx_twcoderdojo_domain_model_person.deleted ORDER BY tx_twcoderdojo_domain_model_person.last_name ASC, tx_twcoderdojo_domain_model_person.first_name ASC',
		...
		'helpers' => array(
			...
			'config' => array(
				...
				'renderType' => 'selectMultipleSideBySide',
				'foreign_table' => 'tx_twcoderdojo_domain_model_person',
				'foreign_table_where' => 'AND tx_twcoderdojo_domain_model_person.type = 2 AND tx_twcoderdojo_domain_model_person.hidden = 0 AND tx_twcoderdojo_domain_model_person.deleted ORDER BY tx_twcoderdojo_domain_model_person.last_name ASC, tx_twcoderdojo_domain_model_person.first_name ASC',
