...
/**
 * Test case for class \Tollwerk\TwCoderdojo\Domain\Model\Person.
 *
...
class PersonTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	public function setUp() {
		$this->subject = new \Tollwerk\TwCoderdojo\Domain\Model\Person();
	}
	 ...
	 * @test
	 */
	public function getAnonymousReturnsInitialValueForBool() {
		$this->assertSame(
			FALSE,
			$this->subject->getAnonymous()
		);
	}
	 ...
	 * @test
	 */
	public function setAnonymousForBoolSetsAnonymous() {
		$this->subject->setAnonymous(TRUE);
