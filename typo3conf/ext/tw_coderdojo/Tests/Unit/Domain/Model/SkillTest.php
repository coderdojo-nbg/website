...
/**
 * Test case for class \Tollwerk\TwCoderdojo\Domain\Model\Skill.
 *
...
class SkillTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Tollwerk\TwCoderdojo\Domain\Model\Skill
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = new \Tollwerk\TwCoderdojo\Domain\Model\Skill();
	}
