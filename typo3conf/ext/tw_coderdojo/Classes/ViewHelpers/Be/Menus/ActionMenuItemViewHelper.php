<?php
namespace Tollwerk\TwCoderdojo\ViewHelpers\Be\Menus;
...
class ActionMenuItemViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper
{
   ...
   */
  public function render($label, $controller, $action, Date $currentDate, array $arguments = array())
  {
    ...
    if (($action === $currentAction) &&
      ...
      (empty($arguments['selectedDate']) ? false : ($currentDate == $arguments['selectedDate']))
    ) {
